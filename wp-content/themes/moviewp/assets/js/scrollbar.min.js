    ...
    e.fn.filmhdPlot = function(t) {
        var i = e.extend({
            ...
            o = {
                init: function() {
                    return this.each(function() {
                        o.appendHTML(), o.initializeItems()
                    })
                },
                addUnderscores: function(e) {
                    return -1 !== e.trim().indexOf(" ") && e.replace(" ", "_"), e
                },
                appendHTML: function() {},
                initializeItems: function() {
                    var t, i = o.addUnderscores(n.page);
                    null !== n.section && (t = "&section=" + n.section), e.ajax({
                        type: "GET",
                        url: n.wikiURL + n.apiPath + "/api.php?action=parse&format=json&prop=text" + t + "&page=" + i + "&callback=?",
                        ...
                        success: function(t, i, a) {
                            try {
                                var c = t.parse.text["*"],
                                    s = e('<div class="nbs-filmhdPlot"></div>').html(c);
                                switch (o.refineResult(s), n.type) {
                                    case "text":
                                        r.html(e(s).find("p"));
                                        break;
                                    case "blurb":
                                        r.html(e(s).find("p:first"));
                                        break;
                                    case "infobox":
                                        r.html(e(s).find(".infobox"));
                                        break;
                                    case "custom":
                                        r.html(e(s).find(n.customSelector));
                                        break;
                                    default:
                                        r.html(s)
                                }
                ...
                refineResult: function(t) {
                    if (n.removeLinks) t.find("a").each(function() {
                        e(this).replaceWith(e(this).html())
                    });
                    else {
                        var i = o.removeTrailingSlash(n.wikiURL);
                    ...
                    return t.find("sup").remove(), t.find(".mw-ext-cite-error").remove(), n.filterSelector && t.find(n.filterSelector).remove(), t
                },
                removeTrailingSlash: function(e) {
                    return "/" === e.substr(-1) ? e.substr(0, e.length - 1) : e
                },
                showError: function() {
                    r.html("<p>"+nobio+" " + n.name + "</p>")
                }
            };
        return o[t] ? o[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error('Method "' + method + '" does not exist!') : o.init.apply(this)
    }
}(jQuery);